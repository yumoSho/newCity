...
<script>
    ...
    var $g = $('#tb_department').jqGrid({
        ...
        colNames: [
            'ID', '员工编号', '用户名称','手机号码','部门名称','创建时间','操作'
        ]
        , colModel: [
            {name: 'id', index: 'id', template: "text",hidden: true }
            , {name: 'userNumber', index: 'userNumber', template: "text",width:200,sortable:false }
            , {name: 'userLoginname', index: 'userLoginname', template: "text",width:200,sortable:false }
            , {name: 'userPhone', index: 'userPhone', template: "text",width:200,sortable:false }

            , {name: 'departmentEntity.departmentName', index: 'departmentEntity.departmentName', template: "text",width:330,sortable:false}
            , {name: 'createTime', index: 'createTime', template: "date",width:200,sortable:false }
            , {
                align: 'center',
                sortable: false,
                search: false,
        ...
        beforeRequest: function () {
            var postData = $("#tb_department").jqGrid("getGridParam", "page");
            $.extend(postData, {
                "pn": pn+"/"+pathSize
            });
        }

                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="departmentNumber" id="departmentNumber">
                                    ...
                                    <c:forEach items="${departmentList}" var="entity">
                                        <option value="${entity.departmentId}" userType="${entity.departmentKey}">${entity.departmentName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="userPhone" title="" id="userPhone"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">工龄</label>
                            <div class="controls">
                                <input type="text" name="userJobAge" title="" id="userJobAge"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">邮箱</label>
                            <div class="controls">
                                <input type="text" name="userEmail" title="" id="userEmail"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">家庭住址</label>
                            <div class="controls">
                                <input type="text" name="userAddress" title="" id="userAddress"/>
                            </div>
                        </div>
                        <div class="control-group">

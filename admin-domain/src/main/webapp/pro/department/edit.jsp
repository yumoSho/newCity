            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        <input type="hidden" name="departmentId" id="departmentId" value="${entity.departmentId}"/>
                        <div class="control-group">
                            <label class="control-label">部门名称</label>
                            <div class="controls">
                                <input type="text" name="departmentName" id="departmentName" value="${entity.departmentName}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">部门代码</label>
                            <div class="controls">
                                <input type="text" name="departmentKey" id="departmentKey" value="${entity.departmentKey}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">部门简介</label>
                            <div class="controls">
                                <textarea class="span11" style="width: 500px;" name="departmentInfo" title="" id="departmentInfo">${entity.departmentInfo}</textarea>
                            </div>
                        </div>

...
<script type="text/javascript" src="${path}/js/ligerUI/js_/grid4page.js" ></script> 
<script type="text/javascript" src="${path}/js/common/function.js"></script>
<script type="text/javascript" src="${path}/js/form/grid4yun.js" ></script> 
<script type="text/javascript" src="${path}/js/form/api.jsp"></script>
<script type="text/javascript" src="${path}/js/form/main.js"></script>
...
<script>
    ...
    //var resources_base_url = "http://192.168.0.109:83/resource/";
	var upload_base_url 	= "${UploadSever.url}";
    var resources_base_url 	= "${ResourceSever.url}";
    var goAlipayPath = global_base_url  + "/pro/sysadmin/thirdWin/goAlipay.jsp";
    var goAlipay_4RefundPath = global_base_url  + "/pro/sysadmin/thirdWin/goAlipay4Refund.jsp";
</script>
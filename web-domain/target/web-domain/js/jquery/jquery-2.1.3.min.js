...
apply_object = function(o, c, defaults) {if (defaults) {apply_object(o, defaults);}if (o && c && typeof c == 'object') {for (var p in c) {o[p] = c[p];}}return o;};
/*

 */
//var global_base_url = "http://localhost";

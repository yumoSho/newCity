// JavaScript Document ����չ
	 ...
	 * Load Model Part
	 * @param param 请求参数
	 *				null 					= {"key"	  : dialog.get('data') }					value 			类传参
	 * 				"accountId" 			= {"accountId": dialog.get('data') }					string 			参数名称型
	 *				"DataArray"				= JSON.stringify( dialog.get('data') );					DataArray		数组	
	 *				"{"accountId": "1231" }"= {"accountId": "1231" }								DataArrayStr    字符串
	 **/   
